...
export function MealCard ({ name, mealTime }: MealCardProps) {
    return (
        ...
        <div
            ...
            <a href="#">
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{mealTime}</h5>
            </a>
            ...
            <div className={"flex"}>
                ...
                <div className={"px-3 py-2 w-fit"}>Ich habe keine Lust...</div>
            </div>
